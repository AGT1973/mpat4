...
changelog_v4_13: IDs de relay/ y subcarpetas corregidos · 2026-05-24 · cursos.ai.agt@gmail.com
---

# MPAT4 — Skill Relay Colaborativo · V4_13
...
## Módulo: [módulo] · Lenguaje: [Python|Rust|FFI] · Versión: V4_13
...
# RELAY_NNN.md
## Autor: [ALUMNO_ID] · [FECHA]
## Módulo: [módulo] · Lenguaje: [Python|Rust|FFI|Multi] · Sistema: MPAT4 V4_13
...
|---|---|---|
| `mpat4-relay` (este) | trabajo general MPAT4 | `SKILL_V4_13_en_gdrive.md` |
...
| Qué cambió | Detalle |
|---|---|
| `relay/` ID corregido | `1c3CP8dM19BGyjOlI8TadmyL1KtV_Tlte` → `1DN0-L3tjW0TVPy2EaAU40aUsUpcJ2aXQ` |
| `relay/active/` ID completado | vacío → `1rE7k0i8x_vD0sNSa8z_66zGEeKunvwG_` |
| `relay/temporal/` ID corregido | `1QehAmh2U7brtnHMDYRuR-SQUDCJyPJVu` → `1UkdGMjAIuWGBYiuJ_w7CDa173FD1Rk3N` |
| `relay/pointer/` ID completado | vacío → `1uC3StJMvPpOizTZOa_OyKPt12oIzTLe_` |
| `relay/docs/` ID completado | vacío → `1MoV0ExVrl1ymlZ3dnt3gPUJsrlQ3zfiW` |
| IDs en PASO 6 | los 3 artefactos de cierre ahora incluyen el ID de carpeta destino |
| Versión en encabezados | V4_12 → V4_13 |
| Autor corrección | cursos.ai.agt@gmail.com · 2026-05-24 |

---

*SKILL_V4_13_en_gdrive.md · AGT 2026-05-24 · cursos.ai.agt@gmail.com*
