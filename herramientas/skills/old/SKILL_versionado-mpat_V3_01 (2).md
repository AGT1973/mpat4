...
# MPAT — Skill de Trabajo Relay Colaborativo · V3_01
...
└── zzz_proximo_relay/                  ← 1oaXdMNDlVL5s7VYLotfL_M4-N8Y6JTFq
    ├── RELAY_001_MPAT_V3_01.md         ← SIEMPRE leer RELAY_NEXT_POINTER primero
...
PASO 1 — LEER ESTADO ACTUAL
  *** PRIMERO: leer RELAY_NEXT_POINTER.md de zzz_proximo_relay/ ***
  → Ese archivo indica el RELAY activo exacto a ejecutar
...
PASO 2 — LEER EL RELAY ACTIVO
  Leer el RELAY_NNN_MPAT_V3_01.md indicado por RELAY_NEXT_POINTER.md
  desde zzz_proximo_relay/
...
| CAPA_00 y CAPA_04 SÍ EXISTEN en V3_01 | Las reales (no placeholders) fueron copiadas |
| SIEMPRE leer RELAY_NEXT_POINTER.md primero | Es la única fuente de verdad del relay activo |
...
*versionado-mpat SKILL · V3_01 · AGT 2026-05-11*
